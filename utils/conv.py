...
cells_df = pd.read_csv('./start-and-stop-test/model/start_and_stop_saving_files/initial.tsv', sep='\t')
...
# Plot
df_filtered.to_csv('./start-and-stop-test/model/start_and_stop_saving_files/cells.csv', index=False)
